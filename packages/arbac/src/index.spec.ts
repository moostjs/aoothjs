...
describe("@aooth/arbac barrel — ISSUE-21: renamed privilege factories must be absent", () => {
...
describe("@aooth/arbac barrel — ISSUE-23: canAccess and canCrud must be absent", () => {
  // Hard-cut contract: canAccess and canCrud were deleted from @aooth/arbac.
...
describe("@aooth/arbac barrel — new API is present", () => {
