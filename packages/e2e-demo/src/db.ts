...
// Generated by dbPlugin({ manifest }) from every @db.table/@db.view export —
// a new .as model joins the sync list without touching this file.
export const ALL_MODELS = atscriptModels;
