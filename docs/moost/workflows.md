...
4. **MFA enrollment** — pick-method → address → confirm, when `resolveMfaPolicy` requires it and the user has none. The TOTP confirm step renders a QR (see [SPA Components — AsQrCode](./spa-components#asqrcode-totp-enrollment)).
