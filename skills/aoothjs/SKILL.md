...
description: >-
  ...
  JWT/session tokens, password+MFA (TOTP), SMS OTP, RBAC
  roles/guards, magic links, password reset, invites,
  ...
  refresh_token grant, RFC 8414/9728 discovery metadata). Covers `@aooth/user`, `@aooth/auth`, `@aooth/idp`,
  ...
  `FederatedLoginService`, `ConsentStore`, consent-only authorize
  (`resolveAuthzReauthPolicy`), or `authGuardInterceptor` /
...
| DB controllers            | [db-controllers.md](references/db-controllers.md)             | `AsArbacDbController` hooks, `ArbacDbScope`, column scopes / hidden fields (incl. `with` sub-scopes hiding related fields in `$with` sub-queries + `/meta`), control-gate semantics, `DENY_FILTER`, identifier auto-preservation                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
